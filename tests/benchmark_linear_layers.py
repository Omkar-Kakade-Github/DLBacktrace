...
from dl_backtrace.pytorch_backtrace.backtrace.utils.layer_refactors.Linear_layer import calculate_wt_fc as calculate_wt_fc_numpy
from dl_backtrace.pytorch_backtrace.backtrace.utils.layer_refactors.Linear_layer_torch_version import calculate_wt_fc_cuda
# Import NumPy-based activations from prop.py
from dl_backtrace.pytorch_backtrace.backtrace.utils.prop import (
